# Makefile for pro_micro_usb_lcd_2
# Kevin Boone, February 2021
...
# Directories that contain the Wire and Wire/util library sources
...
PROG_OBJS=usb_lcd.o lcd8574arduino.o Wire.o twi.o lcdterm.o
